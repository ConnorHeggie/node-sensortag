...
var MPU9250_WOM_MASK                        = 0x0080;	//Mask for wake on motion
...
CC2650SensorTag.prototype.enableWakeOnMotion = function(callback) {		//Enables wake on motion
	this.enableMPU9250(MPU9250_WOM_MASK, callback);
};

CC2650SensorTag.prototype.disableWakeOnMotion = function(callback) {
	this.disableMPU9250(MPU9250_WOM_MASK, callback);
};

CC2650SensorTag.prototype.enable9AxisandWOM = function(callback) {		//Enables wake on motion and full 9 axis
	this.enableMPU9250((MPU9250_WOM_MASK | MPU9250_GYROSCOPE_MASK | MPU9250_ACCELEROMETER_MASK | MPU9250_MAGNETOMETER_MASK), callback);
};

CC2650SensorTag.prototype.disable9AxisandWOM = function(callback) {		//Disables wake on motion and full 9 axis
	this.disableMPU9250((MPU9250_WOM_MASK | MPU9250_GYROSCOPE_MASK | MPU9250_ACCELEROMETER_MASK | MPU9250_MAGNETOMETER_MASK), callback);
};

CC2650SensorTag.prototype.enable9Axis = function(callback) {		//Enables wake on motion and full 9 axis
	this.enableMPU9250((MPU9250_GYROSCOPE_MASK | MPU9250_ACCELEROMETER_MASK | MPU9250_MAGNETOMETER_MASK), callback);
};

CC2650SensorTag.prototype.disable9Axis = function(callback) {		//Disables wake on motion and full 9 axis
	this.disableMPU9250((MPU9250_GYROSCOPE_MASK | MPU9250_ACCELEROMETER_MASK | MPU9250_MAGNETOMETER_MASK), callback);
};
